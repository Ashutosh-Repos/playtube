  ...
  return (
    <Form {...form}>
      <form
        ...
        className={cn(
          "flex items-center justify-center gap-2 rounded w-full h-full  relative sm:bg-transparent max-sm:absolute sm:max-w-lg bg-background max-sm:pl-4 max-sm:z-20 sm:pr-2 sm:border-r",
              ...
              <FormControl>
                <span className="relative w-full h-full">
                  ...
                  <span className="absolute w-auto h-full right-0 top-1/2 -translate-y-1/2 px-3 rounded-r-full cursor-pointer  grid place-items-center bg-accent">
                    <IconSearch className="text-muted-foreground w-6 h-6" />
                  </span>
                </span>
              </FormControl>
      ...
      {!isFormActive && (
        <IconSearch
          className="rounded-full bg-background hover:bg-accent border h-9 w-9 p-2 cursor-pointer sm:hidden"

...
type PrismaClient = any; // Use 'any' until Prisma client is generated
 ...
 */
export async function cleanupProcessedOutboxEvents(
  prisma: PrismaClient,
 ...
 */
export async function runAllCleanupTasks(prisma: PrismaClient): Promise<{
